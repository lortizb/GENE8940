...
datapath <- "/path/to/directory/of/kallisto/results"  # you need to modify this line
resultdir <- "/path/to/directory/of/sleuth/results"   # you need to modify this line
setwd(resultdir)
...
differentially_expressed_gene1="full_id_string_from_gene_with_lowest_pvalue"     # you need to modify this line
differentially_expressed_gene2="full_id_string_from_gene_with_2nd_lowest_pvalue" # you need to modify this line
